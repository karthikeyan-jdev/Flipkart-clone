                  ...
                  <div className="flex flex-col gap-[7px]">
                    ...
                    <div className="flex gap-2">
                      ...
                      <p className="">
                        Bank Offer{" "}
                        <span className="text-gray-500">
                          5% cashback on Axis Bank Flipkart Debit Card up to
                          ₹750
                        </span>{" "}
                        <span className="text-blue-600 pl-1">T&C</span>
                      </p>
                    ...
                    <div className="flex gap-2">
                      ...
                      <p className="">
                        Bank Offer{" "}
                        <span className="text-gray-500">
                          5% cashback on Flipkart SBI Credit Card upto ₹4,000
                    ...
                    <div className="flex gap-2">
                      ...
                      <p className="">
                        Bank Offer{" "}
                        <span className="text-gray-500">
                          Bank Offer5% cashback on Flipkart Axis Bank Credit
                          Card upto ₹4,000 per statement quarter{" "}
                        </span>{" "}
                        <span className="text-blue-600 pl-1">T&C</span>
                      </p>
                    </div>
