  ...
  return (
    <section className="relative !py-[14px] ">
      <div className="bg-white">
        ...
        <div>
          <button
            className="hidden xl:block absolute top-1/3 left-0 
          z-30 banner-prev bg-gray-200 
          ...
          <button
            className="hidden xl:block absolute top-1/3 right-0
           z-30 banner-next bg-gray-200 
          transition-colors duration-300 hover:text-white
          focus:outline-none focus:ring-2 h-[80px] w-[30px]"
          >
            <ChevronRight />
